...
namespace cs112 {
    ...
    public ref class DC : public System::Windows::Forms::Form
    {
        User^ user; // Declare user variable
        Form^ homeForm;
    public:
        DC(User^ user, Form^ Home)
        {
            InitializeComponent();
    ...
    private: User^ currentUser;
           ...
           void LoadMoviesFromExcel()
           {
               ...
               try
               {
                   ...
                   OleDbCommand^ cmd = gcnew OleDbCommand("SELECT * FROM [DC$]", conn);
           ...
           void CreateDynamicPanels()
           {
               ...
               for (int i = 0; i < movies->Count; i++)
               {
                   ...
                   panel->Click += gcnew System::EventHandler(this, &DC::MoviePanel_Click);
                   ...
                   pictureBox->Click += gcnew System::EventHandler(this, &DC::MoviePanel_Click);
                   ...
                   labelPanel->Click += gcnew System::EventHandler(this, &DC::MoviePanel_Click);
                   ...
                   label->Click += gcnew System::EventHandler(this, &DC::MoviePanel_Click);
                   label->MouseEnter += gcnew System::EventHandler(this, &DC::MovieLabel_MouseEnter);
                   label->MouseLeave += gcnew System::EventHandler(this, &DC::MovieLabel_MouseLeave);
...
#pragma region Windows Form Designer generated code
           ...
           {
               System::ComponentModel::ComponentResourceManager^ resources = (gcnew System::ComponentModel::ComponentResourceManager(DC::typeid));
               ...
               this->home->Click += gcnew System::EventHandler(this, &DC::home_Click);
               // 
               // logo
               // 
