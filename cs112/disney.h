...
namespace cs112 {
    ...
    public ref class disney : public System::Windows::Forms::Form
    {
        User^ user; // Declare user variable
        Form^ homeForm;
    public:
        disney(User^ user, Form^ Home)
        {
            InitializeComponent();
    ...
    private: User^ currentUser;
           ...
           void LoadMoviesFromExcel()
           {
               ...
               try
               {
                   ...
                   OleDbCommand^ cmd = gcnew OleDbCommand("SELECT * FROM [Disney$]", conn);
           ...
           void CreateDynamicPanels()
           {
               ...
               for (int i = 0; i < movies->Count; i++)
               {
                   ...
                   panel->Click += gcnew System::EventHandler(this, &disney::MoviePanel_Click);
                   ...
                   pictureBox->Click += gcnew System::EventHandler(this, &disney::MoviePanel_Click);
                   ...
                   labelPanel->Click += gcnew System::EventHandler(this, &disney::MoviePanel_Click);
                   ...
                   label->Click += gcnew System::EventHandler(this, &disney::MoviePanel_Click);
                   label->MouseEnter += gcnew System::EventHandler(this, &disney::MovieLabel_MouseEnter);
                   label->MouseLeave += gcnew System::EventHandler(this, &disney::MovieLabel_MouseLeave);
...
#pragma region Windows Form Designer generated code
           ...
           {
               System::ComponentModel::ComponentResourceManager^ resources = (gcnew System::ComponentModel::ComponentResourceManager(disney::typeid));
               ...
               this->home->Click += gcnew System::EventHandler(this, &disney::home_Click);
               this->logo->BackColor = System::Drawing::Color::Transparent;
               this->logo->BackgroundImageLayout = System::Windows::Forms::ImageLayout::Stretch;
               this->logo->Image = (cli::safe_cast<System::Drawing::Image^>(resources->GetObject(L"logo.Image")));
               this->logo->Location = System::Drawing::Point(0, 1);
               this->logo->Name = L"logo";
               this->logo->Size = System::Drawing::Size(107, 102);
               this->logo->SizeMode = System::Windows::Forms::PictureBoxSizeMode::StretchImage;
               this->logo->TabIndex = 2;
               this->logo->TabStop = false;
               this->label1->AutoSize = true;
               this->label1->Font = (gcnew System::Drawing::Font(L"Viner Hand ITC", 28.2));
               ...
               this->ClientSize = System::Drawing::Size(1062, 871);
