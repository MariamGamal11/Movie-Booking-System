...
namespace cs112 {
    ...
    public ref class Marvel : public System::Windows::Forms::Form
    {
    private:
        User^ user; // Declare user variable
        Form^ homeForm;
    public:
        Marvel(User^ user,Form^Home) // Constructor to accept user
        {
            InitializeComponent();
    ...
    private:
        List<Movie^>^ movies;
    private: System::Windows::Forms::PictureBox^ marvelpic;
    ...
    private: System::Windows::Forms::PictureBox^ home;
           ...
           void LoadMoviesFromExcel()
           {
               ...
               try
               {
                   ...
                   // Fetch sheet name (marvelM$)
                   DataTable^ schemaTable = conn->GetOleDbSchemaTable(OleDbSchemaGuid::Tables, nullptr);

                   OleDbCommand^ cmd = gcnew OleDbCommand("SELECT * FROM [marvelM$]", conn);
           ...
           void CreateDynamicPanels()
           {
               ...
               int spacing = 30;
               int panelsPerRow = 4;
               int startY = marvelpic->Bottom + spacing;
               ...
               for (int i = 0; i < movies->Count; i++)
               {
                   ...
                   panel->Click += gcnew System::EventHandler(this, &Marvel::MoviePanel_Click);
                   ...
                   pictureBox->Click += gcnew System::EventHandler(this, &Marvel::MoviePanel_Click);
                   ...
                   labelPanel->Click += gcnew System::EventHandler(this, &Marvel::MoviePanel_Click);
                   ...
                   label->Click += gcnew System::EventHandler(this, &Marvel::MoviePanel_Click);
                   label->MouseEnter += gcnew System::EventHandler(this, &Marvel::MovieLabel_MouseEnter);
                   label->MouseLeave += gcnew System::EventHandler(this, &Marvel::MovieLabel_MouseLeave);
...
#pragma region Windows Form Designer generated code
           ...
           {
               System::ComponentModel::ComponentResourceManager^ resources = (gcnew System::ComponentModel::ComponentResourceManager(Marvel::typeid));
               this->panel13 = (gcnew System::Windows::Forms::Panel());
               this->logo = (gcnew System::Windows::Forms::PictureBox());
               this->label1 = (gcnew System::Windows::Forms::Label());
               this->marvelpic = (gcnew System::Windows::Forms::PictureBox());
               this->home = (gcnew System::Windows::Forms::PictureBox());
               this->panel13->SuspendLayout();
               (cli::safe_cast<System::ComponentModel::ISupportInitialize^>(this->logo))->BeginInit();
               (cli::safe_cast<System::ComponentModel::ISupportInitialize^>(this->marvelpic))->BeginInit();
               ...
               this->logo->Size = System::Drawing::Size(104, 102);
               ...
               // marvelpic
               // 
               this->marvelpic->Image = (cli::safe_cast<System::Drawing::Image^>(resources->GetObject(L"marvelpic.Image")));
               this->marvelpic->Location = System::Drawing::Point(406, 125);
               this->marvelpic->Name = L"marvelpic";
               this->marvelpic->Size = System::Drawing::Size(215, 94);
               this->marvelpic->SizeMode = System::Windows::Forms::PictureBoxSizeMode::StretchImage;
               this->marvelpic->TabIndex = 1;
               this->marvelpic->TabStop = false;
               // 
               // home
               // 
               ...
               this->home->Click += gcnew System::EventHandler(this, &Marvel::home_Click);
               // 
               // Marvel
               // 
               ...
               this->ClientSize = System::Drawing::Size(1062, 829);
               this->Controls->Add(this->home);
               this->Controls->Add(this->marvelpic);
               this->Controls->Add(this->panel13);
               this->Name = L"Marvel";
               this->StartPosition = System::Windows::Forms::FormStartPosition::CenterScreen;
               this->Text = L"Mainform";
               this->Load += gcnew System::EventHandler(this, &Marvel::Marvel_Load);
               this->panel13->ResumeLayout(false);
               this->panel13->PerformLayout();
               (cli::safe_cast<System::ComponentModel::ISupportInitialize^>(this->logo))->EndInit();
               (cli::safe_cast<System::ComponentModel::ISupportInitialize^>(this->marvelpic))->EndInit();
...
private: System::Void Marvel_Load(System::Object^ sender, System::EventArgs^ e) {
}
};
}