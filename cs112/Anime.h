    ...
    private: User^ currentUser;
           ...
           void LoadMoviesFromExcel()
           {
               ...
               try
               {
                   ...
                   OleDbCommand^ cmd = gcnew OleDbCommand("SELECT * FROM [Anime$]", conn);
           ...
           void CreateDynamicPanels()
           {
               ...
               for (int i = 0; i < movies->Count; i++)
               {
                   ...
                   panel->Click += gcnew System::EventHandler(this, &Anime::MoviePanel_Click);
                   ...
                   pictureBox->Click += gcnew System::EventHandler(this, &Anime::MoviePanel_Click);
                   ...
                   labelPanel->Click += gcnew System::EventHandler(this, &Anime::MoviePanel_Click);
                   ...
                   label->Click += gcnew System::EventHandler(this, &Anime::MoviePanel_Click);
                   label->MouseEnter += gcnew System::EventHandler(this, &Anime::MovieLabel_MouseEnter);
                   label->MouseLeave += gcnew System::EventHandler(this, &Anime::MovieLabel_MouseLeave);
...
#pragma region Windows Form Designer generated code
           ...
           {
               System::ComponentModel::ComponentResourceManager^ resources = (gcnew System::ComponentModel::ComponentResourceManager(Anime::typeid));
               ...
               this->home->Click += gcnew System::EventHandler(this, &Anime::home_Click);
               // 
               // logo
               // 
               ...
               this->logo->Size = System::Drawing::Size(110, 102);
